...
<head>
    ...
    <title>March Fashion - Đăng kí tài khoản</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li><a style="color: #fff;" class="nav-link" href="{{ asset('dangnhap') }}">{{ __('Đăng nhập') }}</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ asset('dangki') }}">
